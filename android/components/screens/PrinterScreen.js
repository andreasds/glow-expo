...
import { activityIndicatorStyle } from '../../constants/styles/printer'
import { buttonStyle, buttonTextStyle } from '../../constants/styles/printer'
import { highlightButtonColor } from '../../constants/styles/printer'
import { containerStyle, containerStyle2, pickerContainer } from '../../constants/styles/printer'
import { dateButtonStyle, dateContainerStyle, dateTextInputStyle } from '../../constants/styles/printer'
import { iconStyle } from '../../constants/styles/printer'
import { lineStyle } from '../../constants/styles/printer'
import { countTextStyle, listContainer, listContainer2, listStyle, listStyle2, listTextStyle } from '../../constants/styles/printer'
import { titleTextStyle } from '../../constants/styles/printer'
...
class PrinterScreen extends Component {
    ...
    constructor(props) {
        ...
        this._reinitializePrinter = this._reinitializePrinter.bind(this)
    }

    _reinitializePrinter(_result) {
    ...
    _onSearchSummaryPressed() {
        if (new Date(this.state.startDate) <= new Date(this.state.endDate)) {
            ...
            if (this.state.summaryType === 'product') {
                summaryProducts(this.props.database.db, this.state.startDate, this.state.endDate, this._reinitializePrinter)
            } else {
                summaryStylists(this.props.database.db, this.state.startDate, this.state.endDate, this._reinitializePrinter)
            }
        } else {
            Alert.alert(
                '',
    ...
    render() {
        ...
        return (
            <View style={containerStyle}>
                <Text style={titleTextStyle}>PRINTER</Text>
                <TouchableHighlight
